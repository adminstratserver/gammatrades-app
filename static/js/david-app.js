...
buildList()
		...
		function buildList(){
			...
			//var url = 'https://hbihub.com/mydocuments/task-list/'
			//var urledit = 'https://hbihub.com/mydocuments/edit/'
...
function deleteItem(item){
		  ...
		  //fetch(`https://hbihub.com/mydocuments/task-delete/${item.id}/`,
			{
				method:'DELETE',
				headers:{
...
function changePublishItem(item){
		  ...
		  //fetch(`https://hbihub.com/mydocuments/task-update/${item.id}/`,
			{
				method:'POST',
				headers:{
					'Content-type':'application/json',
